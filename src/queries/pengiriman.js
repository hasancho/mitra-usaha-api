...
const updateDataPengiriman =
  'UPDATE pengiriman SET kode_tujuan = $1, tujuan = $2, tarif = $3, biaya_pokok = $4, komisi = $5 where id_pengiriman = $6';
const deleteDataPengiriman = 'DELETE FROM pengiriman WHERE id_pengiriman = $1';
